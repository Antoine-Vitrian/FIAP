...
carros = {
    ...
    "portas": [4,6,2,4],
    "preços": [1000,200,300,100],
    "ano": [2014,2018,1970,2005]
}

maior = 0
for i in range(len(carros["preços"])):
    if carros["preços"][i] < maior:
        maior = i
    else:
        pass
print(f"Modelo: {carros['nomes'][maior]}\n"
      f"Preço: {carros['preços'][maior]}\n"
      f"Modelo: {carros['portas'][maior]}\n"
      f"Modelo: {carros['ano'][maior]}")
